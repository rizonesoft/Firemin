...
#AutoIt3Wrapper_OutFile=..\Edgemin.exe							;~ Target exe/a3x filename.
#AutoIt3Wrapper_OutFile_X64=..\Edgemin_X64.exe					;~ Target exe filename for X64 compile.
...
#AutoIt3Wrapper_Res_Fileversion=11.8.3.8522
...
Global $g_sBrowserPath		 = "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe"
...
Func _SetResources()
	...
	Else
		...
		$g_aCoreIcons[1] = $g_sThemesDir & "Resources\Icons\" & $g_sProgShortName & "H.ico"
...
Func _LoadConfiguration()
	...
	$g_sBrowserPath = IniRead($g_sPathIni, $g_sProgShortName, "BrowserPath", "C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe")
