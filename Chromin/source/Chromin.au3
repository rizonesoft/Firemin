...
#AutoIt3Wrapper_OutFile=..\Chromin.exe							;~ Target exe/a3x filename.
#AutoIt3Wrapper_OutFile_X64=..\Chromin_X64.exe					;~ Target exe filename for X64 compile.
...
Func _LoadBrowser($sBrowserPath)
	...
	If FileExists($sBrowserPath) Then
		...
		;~ $g_sBrowserPath = @ProgramFilesDir & "\Google\Chrome\Application\chrome.exe"
